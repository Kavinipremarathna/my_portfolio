...
const Dashboard = ({ token, setToken }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const message = err.response?.data?.msg || "Error saving project";
      alert(message);
    }
  };
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid gap-4">
          {projects.map((project) => (
            <div
              key={project._id}
              className="bg-secondary p-4 rounded-lg border border-slate-700 flex justify-between items-center"
            >
